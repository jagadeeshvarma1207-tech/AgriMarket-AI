    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        <div className="dashboard-header">
          <div>
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.2rem', margin: 0 }}>Add New Product</h1>
            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.8rem', margin: 0 }}>Create a new product listing</p>
          </div>
        </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div className="card">
                  ...
                  <p style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', marginBottom: 16 }}>
                    Upload clear, well-lit photos. First image will be the main display image.
                  </p>
                  <ImageUpload
                    onUpload={addImage}
                    subDir="products"
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  ...
                  <button type="submit" className="btn btn-primary" style={{ flex: 2 }} disabled={loading}>
                    {loading ? <><div className="spinner" style={{ width: 16, height: 16 }} /> Saving...</> : <><Save size={16} /> Publish Product</>}
                  </button>
                </div>
              </div>
            </div>
